...
[![Voice User Interface](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/1-on._TTH_.png)](https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/voice-user-interface/README.md)[![Lambda Function](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/2-off._TTH_.png)](https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/Lambda-Function/README.md)[![Connect VUI to Code](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/3-off._TTH_.png)](https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/connect-vui-to-code/README.md)[![Testing](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/4-off._TTH_.png)](https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/testing/README.md)[![Customization](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/5-off._TTH_.png)](https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/Customization/README.md)[![Publication](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/navigation/6-off._TTH_.png)](https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/publication/README.md)

[Click Here](../../README.md) to return to the Recipe guide.

## Connecting Your Voice User Interface To Your Lambda Function

On [page #1](https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/voice-user-interface/README.md) of this guide, we created a voice user interface for the intents and utterances we expect from our users.  On [page #2](https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/Lambda-Function/README.md), we created a Lambda function that contains all of our logic for the skill.  On this page, we need to connect those two pieces together.
...
7.  **Click the "Next" button to continue to page #4 of this guide.**
    ...
    [![Testing](https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/general/3-7-next-button._TTH_.png)](https://github.com/alexa/skill-sample-nodejs-fact/blob/master/step-by-step/4-testing.md)

<br/><br/>
<a href="https://github.com/voicehacks/Recipe/Detailed-Setup-Instructions/testing/README.md"><img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/general/buttons/button_next_testing._TTH_.png" /></a>
